        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (selectedCar != null) {
                    ...
                    System.out.println("Bike: " + selectedCar.getBrand() + " " + selectedCar.getModel());
...
public class Main{
    public static void main(String[] args) {
        ...
        Car car1 = new Car("C001", "Royal Enfield", "Continental GT 650", 85.0); // Different base price per day for each car
        Car car2 = new Car("C002", "Honda", "CB350", 70.0);
        Car car3 = new Car("C003", "Kawasaki", "Ninja H2", 150.0);
